...
CreateExcelModelFile(direct = direct, 
                     ...
                     area = "1B", LastYearsModelRData = "SPA1B_Model_2022", 
                     savefile = T)
...
raw.dat <- read.xlsx(paste0(direct,"/",assessmentyear,"/Assessment/Data/Model/SPA",area,"/SPA1B_ModelData_R_2023-10-19.xlsx"),sheet = "AlignedForModel", cols=1:13) 
str(raw.dat)
...
decision <- predict(mod.res, Catch=c(seq(400,825,50)), g.parm=mod.res$data$g[mod.res$data$NY],gr.parm=mod.res$data$gR[mod.res$data$NY])
...
stats.output <- BoF.model.stats(area = "1B", assessmentyear=2023, surveyyear=2023, direct = "Y:/Inshore/BoF/", RDatafile = "SPA1B_Model_2023")
...
png(paste0(direct,"/",assessmentyear,"/Assessment/Figures/SPA1B_population_number_index",surveyyear,".png"), type="cairo", width=30, height=15, units = "cm", res=300)
I.N.plot.2
dev.off() 
