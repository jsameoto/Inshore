...
CreateExcelModelFile(direct = direct, 
                     ...
                     area = "1B", LastYearsModelRData = "SPA1B_Model_2021", 
                     savefile = T)
...
raw.dat <- read.xlsx(paste0(direct,"/",assessmentyear,"/Assessment/Data/Model/SPA",area,"/SPA1B_ModelData_R_2022-10-31.xlsx"),sheet = "AlignedForModel", cols=1:13) 
str(raw.dat)
...
decision <- predict(mod.res, Catch=c(seq(150,650,25)), g.parm=mod.res$data$g[mod.res$data$NY],gr.parm=mod.res$data$gR[mod.res$data$NY])
...
stats.output <- BoF.model.stats(area = "1B", assessmentyear=2022, surveyyear=2022, direct = "Y:/Inshore/BoF/", RDatafile = "SPA1B_Model_2022")
