...
CreateExcelModelFile(direct = direct, 
                     ...
                     area = 4, LastYearsModelRData = "SPA4_Model_2021", 
                     savefile = T)
...
raw.dat <- read.xlsx(paste0(direct,"/",assessmentyear, "/Assessment/Data/Model/SPA",area,"/SPA4_ModelData_R_2022-10-31.xlsx"),sheet = "AlignedForModel", cols=1:13)
...
decision <- predict(mod.res, Catch=c(seq(80,220,10)), g.parm=mod.res$data$g[mod.res$data$NY],gr.parm=mod.res$data$gR[mod.res$data$NY])
...
stats.output <- BoF.model.stats(area = "4", assessmentyear=2022, surveyyear=2022, direct = "Y:/Inshore/BoF/", RDatafile = "SPA4_Model_2022")
