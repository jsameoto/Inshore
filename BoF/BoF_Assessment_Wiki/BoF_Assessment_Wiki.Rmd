---
title: Bay of Fundy Scallop Assessment Script Workflow
...
The Bay of Fundy assessment is separated by Scallop Production areas:

SPA1A, SPA1B, SPA3, SPA4 and SPA5, and SPA6
...
-   **Output(s):**
    ...
    towsdd_StdDepth.csv, BoFMeanDepths.csv (derived from this depth
    data, does not change and will not need to be reproduced. Used in [7. Growth Rates (Growth)]
...
#dir_tree(path = paste0("Y:/Inshore/BoF/", year, "/Assessment/Scripts/Growth")) #Prints out directory structure
#rm(list = ls()) #Clear Global Environment

file.show(paste0("Y:/Inshore/BoF/",year,"/Assessment/Scripts/Growth/BoF_MeatWeightShellHeight_",year,".R")) #Script for SPA 1A, 1B, 4 and 5.
file.show(paste0("Y:/Inshore/BoF/",year,"/Assessment/Scripts/Growth/SPA3_MeatWeightShellHeight_",year,".R")) #Script for SPA 3
file.show(paste0("Y:/Inshore/BoF/",year,"/Assessment/Scripts/Growth/SPA6_MeatWeightShellHeight_",year,".r")) #Script for SPA 6

#Eventually will be housed on github repo
#file.show(paste0(dir, "/BoF/Growth/BoF_MeatWeightShellHeight.R"))
file.show(paste0(dir, "/BoF/Growth/SPA3_MeatWeightShellHeight.R"))
#file.show(paste0(dir, "/BoF/Growth/SPA6_MeatWeightShellHeight.r"))
