...
#save
ggsave(filename = paste0("Y:/Inshore/SFA29/", assessment.year,"/Assessment/Figures/ScallopSDM_binned_greyscale.png"), plot = last_plot(), scale = 2.5, width = 7, height = 5, dpi = 300, units = "cm", limitsize = TRUE)
